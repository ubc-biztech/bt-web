...
const ProductX2025 = (params) => {
  ...
  const renderStatus = () => {
    ...
    if (status === "reviewing") {
      ...
      return <img src={Waitlist} alt={"You are currently waitlisted for ProductX"} style={renderMobileOnly ? customStyles.backgroundMobile : customStyles.background} />;
      ...
      return <>{userRegistration.registrationStatus === "registered" ? <span style={{
        ...
        }}>To confirm your acceptance, pay for ProductX here</span> <Button
      ...
      <img src={Accepted} alt={"You have been accepted into ProductX!"} style={renderMobileOnly ? customStyles.backgroundMobile : customStyles.background} /></>;
              ...
              <div style={{
                ...
                ...(renderMobileOnly && {
                  fontSize: constantStyles.mobileFontSize
                    ...
                    Contact <a href="mailto:ethanx@ubcbiztech.com" style={customStyles.mailToLink}>ethanx@ubcbiztech.com</a> for any questions or concerns.
              </div>
            </>
    }
  </div>

        ...
        <Grid item xs={renderMobileOnly ? 12 : 4}>
          <Grid item xs={12}>
            <CustomSelect
              {...props}
              label='Faculty *'
              listOfOptions={['Arts', 'Commerce', 'Science', 'Engineering', 'Kinesiology', 'Land and Food Systems', 'Forestry']}
              groupName='faculty'
            />
          </Grid>
          ...
          <Grid item xs={12}>
            <CustomSelect
              ...
              listOfOptions={['1st Year', '2nd Year', '3rd Year', '4th Year', '5+ Year']}
              groupName='year'
            />
          </Grid>
          ...
          <Grid item xs={12}>
            <CustomSelect
              ...
              listOfOptions={['He/Him/His', 'She/Her/Hers', 'They/Them/Their', 'Prefer not to say']}
              groupName='gender'
            />
          </Grid>

    ...
    <div className={classes.layout}>
      ...
      <Fragment>
        ...
        <div className={classes.registrationHeader}>
          ...
          <Typography className={classes.description}>
            Please be aware that membership does not guarantee your admission to
            all of our events. Some events may specify competitive application
            processes where not all applicants are accepted.
          </Typography>
          <Typography>

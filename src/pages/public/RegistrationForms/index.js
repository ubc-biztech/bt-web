        ...
        {formType === '' && (
          <Fragment>
            ...
            <div className={classes.options}>
              {!user && (
                <Button color="primary" className={classes.selectButton} onClick={() => setFormType('UserMember')}>
                  <div style={{flexDirection: 'column'}}>
                  <Typography>User + Membership 2022/23 Registration</Typography>
                  <img src={House} alt="not-found"/>
                  <Typography>I am not a user yet and want to make my account and membership all at once!</Typography>
                  </div>
                </Button>
              )}
              <Button color="primary" className={classes.selectButton} onClick={() => setFormType('Member')}>
                <div style={{flexDirection: 'column'}}>
                <Typography>Membership 2022/23 Registration</Typography>
                <img src={Login} alt="not-found" className={classes.loginIcon} />
                <Typography>I am a user already and am here to sign up or renew my membership status!</Typography>
                </div>
              </Button>
            </div>
          </Fragment>

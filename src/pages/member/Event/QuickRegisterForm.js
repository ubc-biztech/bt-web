      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <Autocomplete
            ...
            onChange={(e, value) => {
              autoCompleteChange("faculty", value);
            }}
            handleHomeEndKeys
            freeSolo
            onInputChange={(e, value) => {
              setFieldValue("faculty", value, false);
            }}
            options={[
              "Science",
              "Commerce",
        ...
        <Grid item xs={12}>
          <Autocomplete
            ...
            onChange={(e, value) => {
              autoCompleteChange("year", value);
            }}
            handleHomeEndKeys
            freeSolo
            onInputChange={(e, value) => {
              setFieldValue("year", value, false);
            }}
            options={[
              "1st Year",
              "2nd Year",
        ...
        <Grid item xs={12}>
          <Autocomplete
            ...
            options={["None", "Vegetarian", "Vegan", "Gluten Free", "Pescetarian", "Kosher", "Halal", "Other"]}
            renderInput={(params) => (
              <TextField
                {...params}
                className={classes.root}
        ...
        <Grid item xs={12}>
          <Autocomplete
            ...
            onChange={(e, value) => {
              autoCompleteChange("gender", value);
            }}
            handleHomeEndKeys
            freeSolo
            onInputChange={(e, value) => {
        ...
        <Grid item xs={12}>
          <Autocomplete
            ...
            onChange={(e, value) => {
              autoCompleteChange("heardFrom", value);
            }}
            handleHomeEndKeys
            freeSolo
            onInputChange={(e, value) => {
              setFieldValue("heardFrom", value, false);
            }}
            options={[
              "Facebook",
              "Boothing",
